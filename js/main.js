...
(function () {
  ...
  var EN = {
    ...
    'nav.proj': 'Projects', 'nav.skills': 'Skills', 'nav.contact': 'Contact',
    ...
    'repo.soon': '· soon',
    'p2.meta': 'Python · team', 'p2.h': 'Electrical machine sizing',
    'p2.p': 'Stator winding design · flux density via reluctance networks · automatic parameter generation.',
    'p2.t2': 'Reluctance networks',
    'p3.h': 'Field-oriented control (FOC)',
    'p3.p': 'Park transforms, PID, observers · cascade control of a DC motor (thyristor bridge, current & speed loops).',
